const inventors = [
  { first: 'Albert', last: 'Einstein', year: 1579, passed: 1955 },
...
'Bellow, Saul', 'Benchley, Robert', 'Benenson, Peter', 'Ben-Gurion, David', 'Benjamin, Walter', 'Benn, Tony', 'Bennington, Chester', 'Benson, Leana', 'Bent, Silas',
'Bentsen, Lloyd', 'Berger, Ric', 'Bergman, Ingmar', 'Berio, Luciano', 'Berle, Milton', 'Berlin, Irving', 'Berne, Eric', 'Bernhard, Sandra', 'Berra, Yogi', 'Berry, Halle',
...
const firstName = inventors.sort(inventor => (inventor.last))

const fullName = inventors.map(inventor => inventor.first + ' ' +inventor.last);
console.table(birthYear, firstName);
